...
console.log("Sum Major Credits:", sumMajorCredits(major1, major2)); // { credits: 7, brand: 'major' }
console.log("Sum Minor Credits:", sumMinorCredits(minor1, minor2)); // { credits: 3, brand: 'minor' }
